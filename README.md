...
```
pacstrap /mnt base linux linux-firmware sof-firmware base-devel grub efibootmgr vim networkmanager dhcpcd reflector iwd alacritty dnsmasq polybar nitrogen  neofetch ranger dmenu systemd-networkd
```
